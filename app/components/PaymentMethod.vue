    ...
    <UiCardContent class="grid gap-6">
      <UiRadioGroup default-value="card" class="grid grid-cols-3 gap-4">
        <div>
          ...
          <UiLabel
            for="card"
            class="flex flex-col items-center justify-between border-2 border-gray7 rounded-md p-4 [&:has([data-state=checked])]:border-accent11 hover:bg-gray3 peer-data-[state=checked]:border-accent11"
          >
            <svg
      ...
      <div class="grid grid-cols-3 gap-4">
        <div class="grid gap-2">
          ...
          <UiSelect>
            ...
            <UiSelectContent>
              ...
              <UiSelectItem value="9">
                September
              </UiSelectItem>
              <UiSelectItem value="10">
                October
              </UiSelectItem>
              <UiSelectItem value="11">
                November
              </UiSelectItem>
        ...
        <div class="grid gap-2">
          ...
          <UiSelect>
            ...
            <UiSelectContent>
              <UiSelectItem v-for="i in 10" :key="i" :value="`${new Date().getFullYear() + i}`">
